...
If you want to get context only, then set --text_only True
...
def main():
    ...
    groupO.add_argument("--text_only", action="store_true",
                        help="True for saving text only")
    ...
    options.text_only = args.text_only
    if args.html:
